...
Q_CONSTINIT static const qt_meta_stringdata_CLASSPlayerENDCLASS_t qt_meta_stringdata_CLASSPlayerENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(7, 19),  // "defuseStatusChanged"
        QT_MOC_LITERAL(27, 0),  // ""
        QT_MOC_LITERAL(28, 10),  // "isDefusing"
        QT_MOC_LITERAL(39, 10),  // "playerDied"
        QT_MOC_LITERAL(50, 4),  // "move"
        QT_MOC_LITERAL(55, 8),  // "presskey"
        QT_MOC_LITERAL(64, 8),  // "keyIndex"
        QT_MOC_LITERAL(73, 9),  // "isPressed"
        QT_MOC_LITERAL(83, 15)   // "updateAnimation"
    },
    "Player",
    "defuseStatusChanged",
    "",
...
void Player::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->defuseStatusChanged((*reinterpret_cast< std::add_pointer_t<bool>>(_a[1]))); break;
        case 1: _t->playerDied(); break;
        case 2: _t->move(); break;
        case 3: _t->presskey((*reinterpret_cast< std::add_pointer_t<int>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<bool>>(_a[2]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &Player::defuseStatusChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &Player::playerDied; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Player::defuseStatusChanged(bool _t1)
{
